...
| <a name="input_high_availability_environments"></a> [high\_availability\_environments](#input\_high\_availability\_environments) | List of environments that are forced to high availability regardless of what `high_availability` is set to.                                                    | `list(string)`                                                                                         | `["ptl","perftest","stg","aat","prod"]` |    no    |
